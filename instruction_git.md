...
Для того, чтобы просмотреть все существующие ветки, введите команду
...
Чтобы создать новую ветку, введите в терминале команду

    git branch <имя_ветки>

### Слияние веток

Чтобы слить две ветки, необходимо зайти в ту ветку, в которую нужно слить, и ввести в терминале команду, указав имя ветки, которую нужно слить

    git merge <имя_ветки>

#### Разрешение конфликтов

В случае, когда в обеих ветках уже произошли какие-либо изменения, возникнет конфликт версий, и редактор текста выдаст оба текста. Необходимо руками откорректировать текст, оставив нужный. 
...
Удалённые репозитории нужны для того, чтобы над одним проектом могли работать одновременно несколько человек.
